...
public class YearsSongRegressionTreeID3depth15 extends AbstractYearsSongRegressionTreeID3 {
	...
	public static void main(String[] args) {
		try {
			RegressionTreeModel buildTanagraID3Tree = TreeBuilder.buildTanagraID3TreeDepth15();
